    ...
    public class AlertEngineService : Service, IAlertEngine
    {
        ...
        protected override ServiceOutcome DoWork()
        {
            ...
            try
            {
                ...
                if (this.Instance.Configuration.Options.ContainsKey("SMTPUserName"))
                    wfParams.Add("SMTPUserName", this.Instance.Configuration.Options["SMTPUserName"]);

                if (this.Instance.Configuration.Options.ContainsKey("SMTPPass"))
                    wfParams.Add("SMTPPass", this.Instance.Configuration.Options["SMTPPass"]);

                if (this.Instance.Configuration.Options.ContainsKey("SSL"))
                    wfParams.Add("SSL", this.Instance.Configuration.Options["SSL"]);
