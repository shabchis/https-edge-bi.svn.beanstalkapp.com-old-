namespace EdgeBI.Wizards.Utils.WizardTester
{
	partial class frmWizardTester
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnActiveDirectory.TabIndex = 0;
			...
			this.cmbReplaceCPA2.TabIndex = 23;
			// 
			// cmbReplaceCPA1
			// 
			...
			this.cmbReplaceCPA1.TabIndex = 22;
			// 
			// button4
			// 
			...
			this.txtDatabseName.TabIndex = 7;
			// 
			// btnCreateNewCube
			// 
			...
			this.btnCreateNewCube.TabIndex = 0;
			...
			this.txtCubeAddressInViewFile.TabIndex = 31;
			// 
			// label15
			// 
			...
			this.txtApplicationFilePathForAddingBook.TabIndex = 29;
			// 
			// label14
			// 
			...
			this.txtPanoramaAdminRefreshFilePath.TabIndex = 27;
			// 
			// label13
			// 
			...
			this.txtBooksXmlTemplatePath.TabIndex = 23;
			// 
			// label11
			// 
			...
			this.txtCubeNamePatternToReplace.TabIndex = 35;
			// 
			// label24
			// 
			...
			this.txtSSISAllCubeTemplate.TabIndex = 33;
			// 
			// label17
			// 
			...
			this.txtSSISCubeTemplate.TabIndex = 31;
			// 
			// label21
			// 
			...
			this.txtRoleMemberName.TabIndex = 44;
			// 
			// label22
			// 
			...
			this.label29.Location = new System.Drawing.Point(693, 64);
