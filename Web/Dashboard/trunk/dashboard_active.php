...
<body>
	<div id="dropdown"> 
		<select name="combo" id="combo">
					<option value="1">Yesterday - <?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-1,date("Y"))));?></option>
						<option value="2">Last 7 days - <?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-30,date("Y"))));?></option>
