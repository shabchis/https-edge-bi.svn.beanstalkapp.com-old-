	...
	<div id="dropdown"> 
		<select name="combo" id="combo">
					<option value="1">Yesterday &nbsp (<?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-1,date("Y"))));?>)</option>
						...
						<option value="4">This Month&nbsp(<?php 
						if(date("Ymd",(strtotime('today'))) == date("Ymd",mktime(0,0,0,date("m"),date("d")-date("d")+1,date("Y"))) ){
						echo date("M",mktime(0,0,0,date("m")-1,date("d"),date("Y")));
						}
						else
						{
						echo date("M",mktime(0,0,0,date("m"),date("d"),date("Y")));
						}?>)</option>
