...
// $url = 'https://console.edge-bi.com/Seperia/DataServices/service.svc/Data?accountID='.$Account_id.'&measureID='.$measureId.'&ranges='.$endDateName1.'-'.$endDateName2.','.$startDateName1.'-'.$startDateName2.'&grouping=channel&diff=True&top=10&dataSort=value1&dataSortDir=DESC&displayMeasures=20,19&functionDisplayMeasures='.$measureId.'';
//Secondary url - contains the cpa corresponding each value
// $urlcpa = 'https://console.edge-bi.com/Seperia/DataServices/service.svc/Data?accountID='.$Account_id.'&measureID=20&ranges='.$endDateName1.'-'.$endDateName2.','.$startDateName1.'-'.$startDateName2.'&grouping=channel&top=10&dataSort=value1&dataSortDir=DESC&functionMeasures='.$measureId.'';
