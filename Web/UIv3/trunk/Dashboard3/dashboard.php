						...
						<div id="table2" class="factTable">
							...
							<table id="top">
								<tr id="tableheader">
									...
									<th class="measure" colspan=2>Net Revenue </th>
									<th>CPA</th>
								</tr>						
							</table>
						</div>
						...
						<div id="innertables2" class="factTableWrapper">
							<div id="table3" class="factTable">
								...
								<table id="upward">
									<tr id="tableheader3">
										<th class="campaign">Campaign</th>
										<th class="flanc" colspan="2">Change</th>
									</tr>					
								</table>
							</div>
...
var title = $('#TopSpendCombo option:selected').text();
	...
	var toptitle = $('#TopCombo option:selected').text();
				 $('th.measure').text(toptitle);
 var flcamptitle = $('#flcamp option:selected').text();
					 $('th.flanc').text(flcamptitle);
...
function loadByMeasures(){
 ...
 toptitle = $('#TopCombo option:selected').text();
				 $('th.measure').text(toptitle);
		LoadTopCampaigns();
	...
	//console.log(startDate);
		...
		success: function(xml) {
						$(xml).find('campaigns').each(function(){
							...
							$('#tableheader').after('<tr id="total1"><td>Account Total</td><td>'+total+'</td><td class="precent">'+totaldiff+'</td><td>'+totalcpa+'</td></tr>');
						});
			...
			var cpa  = $(this).find('cpa').text();
					...
					$('<tr class="topcpa"><td class="name" title="'+fullname+'">'+name+'</td><td class="middle">'+value1+'</td><td class="last"><span class="con"><span class="precent">'+diff+'</span></span></td><td>'+cpa+'</td></tr>').appendTo('#top');
	...
	$.ajax({
		...
		success: function(xml) {
					$(xml).find('campaigns').each(function(){
							...
							$('#tableheader2').after('<tr id="total2"><td>Account Total</td><td>'+total+'</td><td class="precent">'+totaldiff+'</td><td>'+totalcpa+'</td></tr>');
						});
			$(xml).find('campaign').each(function(){
			var name = $(this).find('name').text();
				var value1 = $(this).find('value').text();
			...
			var cpa  = $(this).find('cpa').text();
					...
					$('<tr class="topcpa"><td title="'+fullname+'">'+name+'</td><td class="middle">'+value1+'</td><td class="last"><span class="con"><span class="precent">'+diff+'</span></span></td><td>'+cpa+'</td></tr>').appendTo('#Worse');
	...
	// $(".loader1").remove();
		...
		$(".loader1").remove();
			...
			$(xml).find('campaigns').each(function(){
							var total = $(this).find('total').text();
								var totaldiff = $(this).find('totaldiff').text();
							$('#tableheader3').after('<tr id="total3"><td>Account Total</td><td >'+totaldiff+'</td><td >'+total+'</td></tr>');
						});
				$(xml).find('campaign').each(function(){
					var name = $(this).find('name').text();
					var value1 = $(this).find('value').text();	
					...
					// $('<tr class="topcpa"><td>'+name+'</td><td>'+cpa+'</td><td class ="last"><span class="con">(<span class="precent">'+diff+'</span>%)</span></td></tr>').appendTo('#Worse');
						$('<tr class="worstcpa"><td title="'+fullname+'">'+name+'</td><td class="middle">'+diff+'</td><td>'+value1+'</td></tr>').appendTo('#downward');
		...
		$(".loader1").remove();
			...
			$(xml).find('campaigns').each(function(){
							var total = $(this).find('total').text();
								var totaldiff = $(this).find('totaldiff').text();
							$('#tableheader4').after('<tr id="total4"><td>Account Total</td><td>'+totaldiff+'</td><td>'+total+'</td></tr>');
						});
				$(xml).find('campaign').each(function(){
					var name = $(this).find('name').text();
					...
					var number = $(this).find('diff_number').text();
						...
						$('<tr class="worstcpa"><td class="name" title="'+fullname+'">'+name+'</td><td class="middle">'+diff+'</td><td>'+value1+'</td></tr>').appendTo('#upward');
			...
			complete:function(xml){
				 ...
				 $('#flcamp').change(function(){
						 flcamptitle = $('#flcamp option:selected').text();
