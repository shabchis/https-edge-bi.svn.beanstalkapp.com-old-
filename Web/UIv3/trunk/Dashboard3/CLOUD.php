	...
	<div id="dropdown"> 
		<select name="combo" id="combo">
					<option value="1">Yesterday &nbsp (<?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-1,date("Y"))));?>)</option>
						<option value="2">Last 7 days&nbsp(<?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-8,date("Y"))));?> - <?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-1,date("Y"))));?>)</option>
						<option value="3">Last 30 days&nbsp(<?php echo (date("d/m/y", mktime(0,0,0,date("m")-1,date("d")-1,date("Y"))));?> -  <?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-1,date("Y"))));?>)</option>
						...
						<option value="6">This Week&nbsp(<?php echo date("d/m/y",strtotime('last monday'));?> - <?php echo (date("d/m/y", mktime(0,0,0,date("m"),date("d")-1,date("Y"))));?>)</option>
						<option value="7">Last Week&nbsp(<?php echo date("d/m/y",strtotime('-2 week monday'));?> - <?php echo date("d/m/y",strtotime('last sunday'));?>)</option>
		</select>
	</div>
...
var title = $('#TopSpendCombo option:selected').text();
	...
	// changeCampaignPerforamceCombo();
		...
		$("#flcamp").load('php/measureDropDown.php?account_id=<?php echo $_REQUEST['account_id'];?>');
		// var endDate = $("#combo option:selected").val()
			// var text = $("#combo option:selected").text();
