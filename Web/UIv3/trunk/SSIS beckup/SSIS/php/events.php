...
// $uniqueResult = array_unique($row);
  ...
  echo "<li class='".$row["event"]."' data-source='".$row["source"]."' data-message='".$row["message"]."' data-time='".date('Y-m-d H:i:s',strtotime($row["starttime"]))."'>" .date('Y-m-d H:i:s',strtotime($row["starttime"]))."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row["event"]."</li>";
}
