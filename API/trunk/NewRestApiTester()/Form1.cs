...
namespace NewRestApiTester__
{
	public partial class Form1 : Form
	{
		...
		{
			List<string> ComboValues = GetListOfValuesBySetting(Properties.Settings.Default.Services);
		...
		{
			List<string> KeyValues = GetListOfValuesBySetting(Properties.Settings.Default.DefaultHeaders);
