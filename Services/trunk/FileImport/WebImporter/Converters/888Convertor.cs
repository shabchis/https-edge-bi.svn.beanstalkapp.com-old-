...
//   [easynet_OLTP].[dbo].[User_GUI_Account].[Account_ID] ";
                ...
                {
                    Log.Write("0 rows for key: " + key + " ,accoutnSettingKey:" + accoutnSettingKey, LogMessageType.Warning);
                    ...
                    { //more than 2 rows {
                        Log.Write("more than 2 tables", LogMessageType.Warning);
                        return "";
                    }
                    else
                    {
                        ...
                        {
							Log.Write("only 1 row found: " + accountNamesDS.Tables[0].Rows[0][0].ToString(), LogMessageType.Warning);
