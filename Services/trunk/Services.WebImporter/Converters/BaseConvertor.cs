    ...
    public  class BaseConvertor
    {
        ...
        protected bool OpenConnection()
        {
            ...
            catch (Exception ex)
            {
              ...
              //  Easynet.Edge.Services.WebImporter.Classes.Convertors.Log.Write(@"D:\log.txt", "Failed to OpenConnection " + e.Message);
        ...
        public List<DataTable> ReadXLSFile(List<string> listFiles)
        {
            ...
            try
            {
                foreach (var item in listFiles)
                {
                    ...
                    { //not cvs file -> XLSX file
                        ...
                        if (InitConnectionString(item) == false)
                        {
                           ...
                           // Easynet.Edge.Services.WebImporter.Classes.Convertors.Log.Write(@"D:\log.txt", "InitConnectionString(item) == false");
                            return null;
                        ...
                        if (OpenConnection() == false)
                        {
                          ...
                          //  Easynet.Edge.Services.WebImporter.Classes.Convertors.Log.Write(@"D:\log.txt", "Cannot open connection !");
                ...
                _connection.Close();
              //  Easynet.Edge.Services.WebImporter.Classes.Convertors.Log.Write(@"D:\log.txt", "_connection.Close();");
            ...
            catch (Exception ex)
            {
               ...
               // Easynet.Edge.Services.WebImporter.Classes.Convertors.Log.Write(@"D:\log.txt", "error ReadXLSFile: " + ex.Message);
